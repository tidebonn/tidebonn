...
export default function PrayerHeadingBlock({ block, onChange, onDelete, onAddLine, onAddHeading, dragHandleProps }) {
  return (
    <div className="group rounded-lg border border-[#C8602A]/30 bg-[#FDF8F5] hover:border-[#C8602A]/50 transition-colors">
      ...
      <div className="flex items-center gap-2 p-2">
            ...
            <button
              ...
              className={`text-xs px-1.5 py-0.5 rounded border transition-colors font-semibold ${
                block.level === level
                  ...
                  : 'bg-white text-[#4A4A4A] border-[#E8E0D8] hover:border-[#C8602A]'
              }`}
            >
              {level.toUpperCase()}
            </button>
        ...
        <div className="flex-1 min-w-0">
          <Input
            ...
            className="font-semibold uppercase tracking-wider text-sm border-[#E8E0D8]"
          />
        </div>
